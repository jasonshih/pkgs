...
class TColumn {
 public:
  ...
  {
    if (__isset.boolColumn != rhs.__isset.boolColumn)
      return false;
    else if (__isset.boolColumn && !(boolColumn == rhs.boolColumn))
      return false;
    if (__isset.byteColumn != rhs.__isset.byteColumn)
      return false;
    else if (__isset.byteColumn && !(byteColumn == rhs.byteColumn))
      return false;
    if (__isset.i16Column != rhs.__isset.i16Column)
      return false;
    else if (__isset.i16Column && !(i16Column == rhs.i16Column))
      return false;
    if (__isset.i32Column != rhs.__isset.i32Column)
      return false;
    else if (__isset.i32Column && !(i32Column == rhs.i32Column))
      return false;
    if (__isset.i64Column != rhs.__isset.i64Column)
      return false;
    else if (__isset.i64Column && !(i64Column == rhs.i64Column))
      return false;
    if (__isset.doubleColumn != rhs.__isset.doubleColumn)
      return false;
    else if (__isset.doubleColumn && !(doubleColumn == rhs.doubleColumn))
      return false;
    if (__isset.stringColumn != rhs.__isset.stringColumn)
      return false;
    else if (__isset.stringColumn && !(stringColumn == rhs.stringColumn))
      return false;
    return true;
  }
  bool operator != (const TColumn &rhs) const {
