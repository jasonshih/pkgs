...
class TExchangeNode:
  ...
  def __init__(self, input_row_tuples=None,):
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i81 in xrange(_size77):
            ...
            self.input_row_tuples.append(_elem82)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.input_row_tuples is not None:
      ...
      for iter83 in self.input_row_tuples:
...
class TPlanNode:
  ...
  def __init__(self, node_id=None, node_type=None, num_children=None, limit=None, row_tuples=None, nullable_tuples=None, conjuncts=None, compact_data=None, hdfs_scan_node=None, hbase_scan_node=None, hash_join_node=None, agg_node=None, sort_node=None, merge_node=None, exchange_node=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i88 in xrange(_size84):
            ...
            self.row_tuples.append(_elem89)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.LIST:
          ...
          for _i94 in xrange(_size90):
            ...
            self.nullable_tuples.append(_elem95)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.LIST:
          ...
          for _i100 in xrange(_size96):
            ...
            _elem101.read(iprot)
            self.conjuncts.append(_elem101)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 8:
  ...
  def write(self, oprot):
    ...
    if self.row_tuples is not None:
      ...
      for iter102 in self.row_tuples:
    ...
    if self.nullable_tuples is not None:
      ...
      for iter103 in self.nullable_tuples:
