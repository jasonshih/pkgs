...
class TCreateTableParams:
  ...
  def __init__(self, table_name=None, columns=None, partition_columns=None, file_format=None, is_external=None, if_not_exists=None, owner=None, row_format=None, comment=None, location=None,):
    self.table_name = table_name
    self.columns = columns
...
class TResultSetMetadata:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i81 in xrange(_size77):
            _elem82 = TColumnDesc()
            _elem82.read(iprot)
            self.columnDescs.append(_elem82)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.columnDescs is not None:
      ...
      for iter83 in self.columnDescs:
        iter83.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class TCatalogUpdate:
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          ...
          for _i88 in xrange(_size84):
            ...
            self.created_partitions.add(_elem89)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.created_partitions is not None:
      ...
      for iter90 in self.created_partitions:
...
class TQueryExecRequest:
  ...
  def __init__(self, desc_tbl=None, fragments=None, dest_fragment_idx=None, per_node_scan_ranges=None, result_set_metadata=None, finalize_params=None, query_globals=None, query_plan=None, stmt_type=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i95 in xrange(_size91):
            _elem96 = Planner.ttypes.TPlanFragment()
            _elem96.read(iprot)
            self.fragments.append(_elem96)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i101 in xrange(_size97):
            ...
            self.dest_fragment_idx.append(_elem102)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
          ...
          for _i107 in xrange(_size103):
            ...
            for _i114 in xrange(_size110):
              _elem115 = Planner.ttypes.TScanRangeLocations()
              _elem115.read(iprot)
              _val109.append(_elem115)
            iprot.readListEnd()
            self.per_node_scan_ranges[_key108] = _val109
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.dest_fragment_idx is not None:
      ...
      for iter117 in self.dest_fragment_idx:
    ...
    if self.per_node_scan_ranges is not None:
      ...
      for kiter118,viter119 in self.per_node_scan_ranges.items():
        oprot.writeI32(kiter118)
        oprot.writeListBegin(TType.STRUCT, len(viter119))
        for iter120 in viter119:
          iter120.write(oprot)
        oprot.writeListEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class TMetadataOpResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'result_set_metadata', (TResultSetMetadata, TResultSetMetadata.thrift_spec), None, ), # 1
    (2, TType.LIST, 'results', (TType.STRUCT,(Data.ttypes.TResultRow, Data.ttypes.TResultRow.thrift_spec)), None, ), # 2
  )

  def __init__(self, result_set_metadata=None, results=None,):
    self.result_set_metadata = result_set_metadata
    self.results = results
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i125 in xrange(_size121):
            _elem126 = Data.ttypes.TResultRow()
            _elem126.read(iprot)
            self.results.append(_elem126)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.result_set_metadata is not None:
      oprot.writeFieldBegin('result_set_metadata', TType.STRUCT, 1)
      self.result_set_metadata.write(oprot)
      oprot.writeFieldEnd()
    if self.results is not None:
      oprot.writeFieldBegin('results', TType.LIST, 2)
      oprot.writeListBegin(TType.STRUCT, len(self.results))
      for iter127 in self.results:
        iter127.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class TExecRequest:
  ...
  thrift_spec = (
    ...
    (4, TType.STRUCT, 'ddl_exec_request', (TDdlExecRequest, TDdlExecRequest.thrift_spec), None, ), # 4
    (5, TType.STRUCT, 'result_set_metadata', (TResultSetMetadata, TResultSetMetadata.thrift_spec), None, ), # 5
    (6, TType.STRUCT, 'explain_result', (TExplainResult, TExplainResult.thrift_spec), None, ), # 6
  )

  def __init__(self, stmt_type=None, query_options=None, query_exec_request=None, ddl_exec_request=None, result_set_metadata=None, explain_result=None,):
    self.stmt_type = stmt_type
  ...
  def write(self, oprot):
    ...
    if self.ddl_exec_request is not None:
      oprot.writeFieldBegin('ddl_exec_request', TType.STRUCT, 4)
