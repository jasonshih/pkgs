...
class TExprNode:
  ...
  def __init__(self, node_type=None, type=None, opcode=None, num_children=None, agg_expr=None, bool_literal=None, case_expr=None, date_literal=None, float_literal=None, int_literal=None, in_predicate=None, is_null_pred=None, like_pred=None, literal_pred=None, slot_ref=None, string_literal=None, tuple_is_null_pred=None,):
